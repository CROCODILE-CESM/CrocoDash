...
def run_full_workflow(
    ...
    if not too_much_data:
        ...
        ds.to_netcdf(case.inputdir / "extract_forcings"/"raw_data" / "east_unprocessed.20200101_20200201.nc")
        ds.to_netcdf(case.inputdir / "extract_forcings"/"raw_data" / "west_unprocessed.20200101_20200201.nc")
        ds.to_netcdf(case.inputdir / "extract_forcings"/"raw_data" / "north_unprocessed.20200101_20200201.nc")
        ds.to_netcdf(case.inputdir / "extract_forcings"/"raw_data" / "south_unprocessed.20200101_20200201.nc")
    else:
        case.configure_forcings(
        ...
        subprocess.run(
            ["python", str(case.inputdir / "extract_forcings/driver.py")]
        )
    # Process Forcings
