...
| `mapping.get_smoothed_map_filepath(...)` | `extract_forcings/runoff.py`, `forcing_configurations/configurations.py` | Generates smoothed runoff-to-ocean mapping files |
...
| `CaseCreator` | `case.py` | Jupyter widget that drives interactive CESM case creation |
