...
class TestBareBones:
    ...
    def test_setup_bathymetry(self, dummy_bathymetry_data):
    ...
    def test_tides(self, dummy_tidal_data):
        ...
        self.crr_driver_obj.wrap_rm6_setup_tides(self.dump_files_dir, "fake_tidal_data.nc")

    def test_run_directory(self):
        self.crr_driver_obj.wrap_rm6_setup_run_directory(
            surface_forcing="jra", with_tides_rectangular=True, overwrite=True, premade_rundir_path_arg=Path("/glade/u/home/manishrv/documents/nwa12_0.1/regional_mom_workflows/crr/crocodileregionalruckus/rm6_dir/demos/premade_run_directories")
        )
