...
def test_write_config_file():
    ...
    input_dir = Path(f"{expt_name}_input/")

    ## Directory where you'll run the experiment from
    run_dir = Path(f"{expt_name}_run")
...
def test_read_config_file():
    ...
    expt = crr.driver.crr_driver.load_experiment_from_config("crr_config.json")
